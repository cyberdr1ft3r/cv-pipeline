...
export function TwoSpaces({
  ...
  sectionTitle = "Built for Your Entire Team",
  sectionSubtitle = "Two Powerful Workspaces",
  sectionDescription = "Separate, specialized environments for sourcing teams and recruiters, united by intelligent automation."
}: TwoSpacesProps) {
  const ref = useRef(null);
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#1e293b]/50 backdrop-blur-sm border border-white/10 rounded-full mb-6">
            <span className="text-sm text-[#818cf8]">{sectionSubtitle}</span>
          </div>
