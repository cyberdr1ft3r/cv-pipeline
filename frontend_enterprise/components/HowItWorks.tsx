...
const steps = [
  {
    ...
    description:
      "Upload candidate CVs in any format—PDF, DOCX, or scanned images. Our system handles bulk uploads and maintains perfect organization.",
    color: "from-[#6366f1] to-[#818cf8]",
  },
  {
    icon: Brain,
    number: "02",
    title: "AI Builds Profiles",
    description:
      "Advanced machine learning extracts, normalizes, and structures all candidate data. Skills, experience, education—everything parsed intelligently.",
    color: "from-[#818cf8] to-[#a78bfa]",
  },
  {
    icon: CheckCircle,
    number: "03",
    title: "Review with Accuracy",
    description:
      "Access ranked candidates, technical test results, and beautifully formatted profiles. Export to your ATS or manage within our platform.",
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#1e293b]/50 backdrop-blur-sm border border-white/10 rounded-full mb-6">
            <span className="text-sm text-[#818cf8]">Simple 3-Step Process</span>
          </div>
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">
            From upload to insights in minutes. Our AI handles the complexity so
            your team can focus on finding the perfect candidates.
          </p>
        </motion.div>
