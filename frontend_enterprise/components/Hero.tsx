...
export function Hero({
  title = "Intelligent Talent Discovery for Modern Hiring Teams",
  subtitle = "Powered by Advanced AI Technology",
  description = "Transform your recruitment workflow with instant AI resume parsing and smart candidate matching. Parse PDFs, DOCX, and scanned documents with enterprise-grade accuracy.",
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-32 text-center">
        ...
        >
          ...
          <span className="bg-gradient-to-r from-[#6366f1] to-[#818cf8] bg-clip-text text-transparent">
            {title.includes(' for ') ? title.split(' for ')[1] : 'for Modern Hiring Teams'}
          </span>
        </motion.h1>
